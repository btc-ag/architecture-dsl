...
import com.btc.arch.generator.generators.TestScriptGenerator;
import com.btc.commons.emf.EcoreUtils;

public class TestSkriptGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new TestScriptGenerator();
