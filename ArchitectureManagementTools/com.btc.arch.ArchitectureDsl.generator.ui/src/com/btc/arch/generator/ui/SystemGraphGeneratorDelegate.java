...
import com.btc.arch.generator.generators.SystemGraphGenerator;
import com.btc.commons.emf.EcoreUtils;

public class SystemGraphGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new SystemGraphGenerator();
