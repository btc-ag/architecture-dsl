...
import com.btc.arch.generator.generators.ModuleGraphGenerator;
import com.btc.commons.emf.EcoreUtils;

public class ModuleGraphGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new ModuleGraphGenerator();
