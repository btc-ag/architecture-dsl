...
import com.btc.arch.generator.generators.JenkinsTestConfigurationGenerator;
import com.btc.commons.emf.EcoreUtils;

public class JenkinsConfigGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new JenkinsTestConfigurationGenerator();
