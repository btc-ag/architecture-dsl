...
import com.btc.arch.visualstudio.generators.VS2008SolutionGenerator;
import com.btc.commons.emf.EcoreUtils;

public class VS2008SolutionGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new VS2008SolutionGenerator();
