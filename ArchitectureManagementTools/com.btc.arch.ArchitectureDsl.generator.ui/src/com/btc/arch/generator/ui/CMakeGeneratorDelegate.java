...
import com.btc.arch.generator.generators.CMakeGenerator;
import com.btc.commons.emf.EcoreUtils;

public class CMakeGeneratorDelegate extends ArchDslGeneratorDelegate {
	...
	public void run(IAction action) {
		try {
			IArchitectureDSLGenerator generator = new CMakeGenerator();
