...
java -classpath ../eclipse_helios/plugins/org.apache.ant_1.7.1.v20100518-1145/lib/ant-launcher.jar org.apache.tools.ant.launch.Launcher -f com.btc.arch.ArchitectureDsl/xtext_build.xml -Dmy.basepath="%WORKDIR%/../eclipse_helios" gen
